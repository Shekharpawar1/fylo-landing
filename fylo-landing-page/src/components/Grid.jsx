    ...
    <div className='grid-container'>
        ...
        <svg width="83" height="78" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fillRule="evenodd">
            ...
            <g transform="translate(55.377 23.07)" stroke="#62E0D9">
              ...
              <ellipse strokeWidth="1.01" cx="13.038" cy="48.519" rx="1.185" ry="1.183" />
            </g>
            <g>
              <path
      ...
      <div className="col3">
        <svg width="86" height="71" xmlns="http://www.w3.org/2000/svg">
          <g stroke="#62E0D9" strokeWidth="1.3" fill="none" fillRule="evenodd" strokeLinejoin="round">
            <path
        ...
        <svg width="91" height="64" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fillRule="evenodd">
            <path
              ...
              stroke="#62E0D9" strokeWidth="1.405" strokeLinecap="round" strokeLinejoin="round" />
            <path
            ...
            <path
              ...
              stroke="#FFF" strokeWidth=".803" strokeLinejoin="round" />
            <path d="M30.01 37.805h12.523m-12.524 3.841h11.272m-11.272 3.842h7.514" stroke="#FFF" strokeWidth=".803"
            ...
            <g>
              <path
                ...
                fill="#62E0D9" />
              <path stroke="#FFF" strokeWidth=".65" strokeLinecap="round" strokeLinejoin="round"
